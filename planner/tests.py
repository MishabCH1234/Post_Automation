...
class PlannerViewTests(TestCase):
    ...
    def test_login_page_renders(self):
        ...
        self.assertContains(response, 'InstaAI Login')
    ...
    def test_dashboard_shows_last_five_days_analytics(self):
        self.client.force_login(self.user)
        plan = WeeklyPlan.objects.create(
            user=self.user,
            title='AI promo',
            description='Caption generated by AI',
        ...
        self.assertContains(response, 'Last 5 Days Performance')
        self.assertContains(response, '150 views')
        self.assertContains(response, '12 likes')
        self.assertContains(response, 'AI promo')
        self.assertContains(response, 'Reach: 90')
